...
> Facilities api_web_facility_controller_index(page_offset=page_offset, page_limit=page_limit, sort=sort, include=include, filter_stop=filter_stop)
...
try:
    # 
    api_response = api_instance.api_web_facility_controller_index(page_offset=page_offset, page_limit=page_limit, sort=sort, include=include, filter_stop=filter_stop)
    pprint(api_response)
...
> Facility api_web_facility_controller_show(id, include=include)
...
try:
    # 
    api_response = api_instance.api_web_facility_controller_show(id, include=include)
    pprint(api_response)
except ApiException as e:
